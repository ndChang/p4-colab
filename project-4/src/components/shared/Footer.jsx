    ...
    <>
      <div className="second-footer">
        <div className="img-container">
          ...
          <img
            ...
            src="http://www.free-icons-download.net/images/solid-heart-shape-icon-75343.png"
          ></img>
        </div>
      ...
      <div className="foot-container">
        ...
        <div className="social-media">
          <p>FOLLOW US</p>
          <img src="https://www.freepngimg.com/thumb/social_media/74167-on-networking-like-service-icons-media-us.png"></img>
        </div>
